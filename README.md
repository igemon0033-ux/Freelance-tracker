...
Telegram-бот для отслеживания заказов с фриланс-бирж (в текущей версии используется парсер `kwork`) с фильтрацией по категориям и отправкой уведомлений пользователям. None-vibecode, проект написан в 2023 году. 

Запущен на https://t.me/OrdersTrackerBot
